...
async def search_candidates(
    ...
    try:
        ...
        print(f"Generated query embedding with {len(query_embedding) if query_embedding else 0} dimensions")
        ...
        for candidate in candidates:
            if candidate.candidate_vector:
                try:
                    score = cosine_similarity(query_embedding, candidate.candidate_vector)
...
async def seed_candidates(
    ...
    try:
        ...
        if existing_count > 0:
            return {"message": f"Database already has {existing_count} candidates. Skipping seed."}
        ...
        dummy_candidates = [
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "AppStudio", "role": "iOS Developer", "duration": "2020-Present", "description": "Developed iOS apps using Swift and SwiftUI for 2M+ users"},
                    {"company": "MobileFirst", "role": "Mobile Developer", "duration": "2019-2020", "description": "Built cross-platform apps using React Native"}
                ],
                "skills": ["Swift", "SwiftUI", "iOS", "React Native", "Firebase", "REST APIs", "Git", "Xcode", "TestFlight"],
                "certifications": ["Apple Certified iOS Developer"],
                "education": [{"degree": "BS Software Engineering", "institution": "University of Washington", "year": 2019}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "Enterprise Solutions", "role": "Senior Backend Engineer", "duration": "2019-Present", "description": "Designed and implemented RESTful APIs using Java Spring Boot"},
                    {"company": "FinanceApp", "role": "Backend Developer", "duration": "2016-2019", "description": "Built payment processing systems using Python and Django"}
                ],
                "skills": ["Java", "Spring Boot", "Python", "Django", "PostgreSQL", "MongoDB", "Redis", "Kafka", "Microservices", "REST APIs"],
                "certifications": ["Oracle Certified Java Programmer", "MongoDB Certified Developer"],
                "education": [{"degree": "BS Computer Science", "institution": "Boston University", "year": 2016}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "DesignTech", "role": "Frontend Developer", "duration": "2021-Present", "description": "Built responsive web applications using React and TypeScript"},
                    {"company": "WebStudio", "role": "Junior Frontend Developer", "duration": "2020-2021", "description": "Developed UI components using Vue.js"}
                ],
                "skills": ["React", "TypeScript", "JavaScript", "HTML", "CSS", "Tailwind CSS", "Redux", "Next.js", "Webpack", "Git"],
                "certifications": ["Meta Frontend Developer Professional Certificate"],
                "education": [{"degree": "BS Information Systems", "institution": "UCLA", "year": 2020}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "DataFlow Inc", "role": "Senior Data Engineer", "duration": "2020-Present", "description": "Built data pipelines processing 10TB+ daily using Apache Spark"},
                    {"company": "Analytics Corp", "role": "Data Engineer", "duration": "2017-2020", "description": "Designed ETL workflows using Python and Airflow"}
                ],
                "skills": ["Python", "Apache Spark", "Airflow", "SQL", "AWS", "Snowflake", "dbt", "Kafka", "Hadoop", "Data Warehousing"],
                "certifications": ["Databricks Certified Data Engineer", "AWS Data Analytics Specialty"],
                "education": [{"degree": "MS Data Engineering", "institution": "Northwestern University", "year": 2017}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "SecureNet", "role": "Principal Security Engineer", "duration": "2018-Present", "description": "Led security architecture and penetration testing for enterprise applications"},
                    {"company": "CyberDefense", "role": "Security Engineer", "duration": "2014-2018", "description": "Implemented security controls and conducted vulnerability assessments"}
                ],
                "skills": ["Penetration Testing", "Security Architecture", "Python", "Burp Suite", "Metasploit", "OWASP", "AWS Security", "Cryptography", "SIEM"],
                "certifications": ["CISSP", "CEH", "OSCP", "AWS Security Specialty"],
                "education": [{"degree": "BS Cybersecurity", "institution": "George Washington University", "year": 2014}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "TestPro", "role": "Senior QA Engineer", "duration": "2020-Present", "description": "Developed automated test frameworks using Selenium and Cypress"},
                    {"company": "SoftwareHouse", "role": "QA Engineer", "duration": "2018-2020", "description": "Created test plans and automated regression tests"}
                ],
                "skills": ["Selenium", "Cypress", "Python", "JavaScript", "TestNG", "JUnit", "Jenkins", "API Testing", "Performance Testing", "Agile"],
                "certifications": ["ISTQB Advanced Test Automation Engineer"],
                "education": [{"degree": "BS Computer Science", "institution": "University of Colorado", "year": 2018}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "CloudArchitects", "role": "Principal Solutions Architect", "duration": "2019-Present", "description": "Designed cloud-native architectures for enterprise clients"},
                    {"company": "TechConsulting", "role": "Solutions Architect", "duration": "2015-2019", "description": "Led technical design for large-scale system migrations"}
                ],
                "skills": ["AWS", "Azure", "System Design", "Microservices", "Serverless", "Kubernetes", "Terraform", "Python", "Java", "Architecture Patterns"],
                "certifications": ["AWS Solutions Architect Professional", "Azure Solutions Architect Expert", "TOGAF Certified"],
                "education": [{"degree": "MS Computer Science", "institution": "Georgia Tech", "year": 2013}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "StartupHub", "role": "Junior Software Engineer", "duration": "2023-Present", "description": "Developing features for web application using React and Node.js"}
                ],
                "skills": ["JavaScript", "React", "Node.js", "HTML", "CSS", "Git", "MongoDB", "Express.js"],
                "certifications": [],
                "education": [{"degree": "BS Computer Science", "institution": "Portland State University", "year": 2023}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "CryptoTech", "role": "Blockchain Developer", "duration": "2021-Present", "description": "Developed smart contracts using Solidity and Web3.js"},
                    {"company": "DeFi Solutions", "role": "Smart Contract Developer", "duration": "2019-2021", "description": "Built DeFi protocols on Ethereum"}
                ],
                "skills": ["Solidity", "Ethereum", "Web3.js", "Smart Contracts", "JavaScript", "Hardhat", "Truffle", "IPFS", "DeFi"],
                "certifications": ["Certified Blockchain Developer"],
                "education": [{"degree": "BS Computer Science", "institution": "University of Miami", "year": 2019}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "ProductCo", "role": "Senior Product Engineer", "duration": "2020-Present", "description": "Led development of customer-facing features using React and Python"},
                    {"company": "GrowthStartup", "role": "Product Engineer", "duration": "2017-2020", "description": "Built analytics dashboard and A/B testing framework"}
                ],
                "skills": ["React", "Python", "TypeScript", "PostgreSQL", "Redis", "AWS", "Product Analytics", "A/B Testing", "Data Visualization"],
                "certifications": ["Product Management Certificate"],
                "education": [{"degree": "BS Computer Science", "institution": "UC San Diego", "year": 2017}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "ReliableOps", "role": "Senior SRE", "duration": "2019-Present", "description": "Maintained 99.99% uptime for critical services handling 1B+ requests/day"},
                    {"company": "ScaleTech", "role": "SRE", "duration": "2016-2019", "description": "Implemented monitoring and incident response systems"}
                ],
                "skills": ["Kubernetes", "Prometheus", "Grafana", "Python", "Go", "Terraform", "AWS", "GCP", "Incident Management", "Monitoring"],
                "certifications": ["Google Cloud Professional Cloud Architect", "CKA"],
                "education": [{"degree": "BS Computer Engineering", "institution": "San Jose State University", "year": 2016}],
            ...
            },
            {
                ...
                "work_history": [
                    {"company": "AI Research Lab", "role": "Research Engineer", "duration": "2020-Present", "description": "Developed novel deep learning architectures for computer vision"},
                    {"company": "ML Innovations", "role": "ML Engineer", "duration": "2018-2020", "description": "Implemented research papers and deployed models to production"}
                ],
                "skills": ["Python", "PyTorch", "TensorFlow", "Computer Vision", "NLP", "Research", "Deep Learning", "CUDA", "Model Optimization"],
                "certifications": ["Published 5 papers in top-tier conferences"],
                "education": [{"degree": "PhD Computer Science (in progress)", "institution": "MIT", "year": 2025}, {"degree": "MS Computer Science", "institution": "Carnegie Mellon", "year": 2018}],
